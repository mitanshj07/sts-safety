...
| Heavy/privileged path | Next.js Route Handlers (`/api/*`) | Blockchain issuance, alert dispatch, E-FIR drafting, admin mutations. Uses the Supabase **service role** key, never exposed to the browser. |
