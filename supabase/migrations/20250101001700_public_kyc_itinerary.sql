...
-- Numbered 01700 so it runs after 01600_kyc_nationality_policy.sql and replaces
-- ensure_demo_tourist with the skip-aware version (kyc_status + default itinerary).
