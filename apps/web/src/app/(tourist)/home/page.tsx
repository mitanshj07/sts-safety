...
export default function TouristHomePage() {
  const { tourist, digitalId, currentZones, itinerary, lastFix, online, tracking, queueDepth } =
    useTouristRuntime();
    ...
    <main className="sts-enter mx-auto flex max-w-lg flex-col px-4 pt-5 pb-4">
      ...
      {!digitalId ? (
        <Link
          ...
          className="mt-4 block border border-brand/30 bg-brand/5 px-4 py-3.5 outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
          <span className="sts-kicker text-brand">Digital ID</span>
