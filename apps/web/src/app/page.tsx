...
const CAPABILITIES = [
  ...
  },
  {
    ...
    body: "Indians fetch eAadhaar via DigiLocker. Visitors use a passport. Only a keccak256 commitment goes on-chain.",
  },
  {
    title: "Live dispatch",
          ...
          <section className="sts-enter grid gap-8 border-t border-border pt-10 sm:grid-cols-2">
            ...
            >
              ...
              <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
                Daylight-first. One-handed. Works when the hills go dark.
              </p>
            </Link>
            <Link
